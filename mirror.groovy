...
node {
    ...
    stage('Fabric-Starter-projects-Snapshot') {
        ...
        stage('Fabric-tools-extended') {
            checkoutFromGithubToSubfolder('fabric-starter-mirror', "${BUILD_BRANCH}")
            // sh("cp -r build/chaincode/node/dns fabric-starter/chaincode/node")

            dir('fabric-starter-mirror') {
                ...
                newFabricStarterTag = evaluateNextSnapshotGitTag('Fabric-starter-mirror')
